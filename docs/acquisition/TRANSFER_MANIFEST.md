# Transfer manifest â€” Full corpus with temporal splits

## Schedule A â€” Included (typical)

1. Git repository `theworker02/patentpulse` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Full corpus with temporal splits
